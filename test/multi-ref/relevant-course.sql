...
wp_career_fair.multi_ref_relevant_course
group by val having c > 1

-- new table 
-- multi_relevant_course
...
-- new table multi_ref_relevant_course
CREATE TABLE `wp_career_fair`.`multi_ref_relevant_course` 
...
insert into wp_career_fair.multi_ref_relevant_course (val, category) VALUES  
('Java Programming','software_engineering'), 
('PHP Programming','software_engineering')
