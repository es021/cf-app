...
export default class InputMulti extends React.Component {
  ...
  setDefaultList(customProps = null) {
    ...
    if (this.props.dataset_source && this.props.dataset_suggestion_offset && this.props.dataset_show_suggestion) {
      let qRef = `query{
        global_dataset_item(
          ...
          page:1, 
          offset:${props.dataset_suggestion_offset}
        ){
          ID
          val
        }
    ...
    } else if (this.props.discard_ref_from_default === false && props.ref_table_name) {
...
InputMulti.propTypes = {
  ...
  dataset_order_by: PropTypes.string,
  dataset_suggestion_offset: PropTypes.number,
  dataset_show_suggestion: PropTypes.bool,
